...
<p class="lead">This ASP.NET demo is using SqlDataSource to View, Edit or Delete catalog items.</p>
    ...
    <div class="row">
        <div class="col-md-4">
            <h2>Catalog list:</h2>
            <p>
                <asp:GridView class="frdView" ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" DataSourceID="SqlDataSource1" Width="626px" AutoGenerateColumns="False" 
                    DataKeyNames="ItemID" CellPadding="4" ForeColor="#333333" GridLines="None">
                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                    <Columns>
                        <asp:CommandField ButtonType="Button" ShowSelectButton="True"/>
                        <asp:BoundField DataField="ItemID" Visible="false" HeaderText="ID" InsertVisible="False" ReadOnly="True" SortExpression="ItemID" />
        ...
        <div class="col-md-4">
            ...
            <p>
                <asp:DetailsView ID="DetailsView1" runat="server" DataSourceID="SqlDataSource2" 
                    Height="50px" Width="378px" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateRows="False">
                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                    <CommandRowStyle BackColor="#E2DED6" Font-Bold="True" />
                    <EditRowStyle BackColor="#999999" />
                    <FieldHeaderStyle BackColor="#E9ECF1" Font-Bold="True" />
                    <Fields>
                        <asp:BoundField DataField="ItemID" HeaderText="ID" InsertVisible="false" ReadOnly="false" SortExpression="ItemID" Visible="true" />
                        <asp:BoundField DataField="ItemName" HeaderText="Name" SortExpression="ItemName" />
                        <asp:BoundField DataField="ItemGenus" HeaderText="Genus" SortExpression="ItemGenus" />
                        <asp:BoundField DataField="ItemSpecies" HeaderText="Species" SortExpression="ItemSpecies" />
                        <asp:BoundField DataField="ItemCatalogNum" HeaderText="Catalog #" SortExpression="ItemCatalogNum" />
